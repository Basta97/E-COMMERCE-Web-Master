...
import Link from "next/link"; // Keep Image import if you plan to use it for the logo
...
export default function Header() {
    return (
        <>
            ...
            <div className=" mx-auto px-4 sm:px-6 lg:px-8 w-full bg-white border-b border-gray-400 py-2 flex justify-between items-center text-sm text-gray-500">
                <div className="flex space-x-4">
                    <Link href="#" className="hover:text-teal-600">About Us</Link>
                    <Link href="#" className="hover:text-teal-600">Contact</Link>
                    <Link href="#" className="hover:text-teal-600">Market</Link>
                </div>
            ...
            <div className="bg-white border-y border-gray-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center space-x-6 py-2">
                    ...
                    <div className="hidden md:flex space-x-6 text-sm font-medium">
                        ...
                        <Link href="#" className="text-gray-600 hover:text-teal-500">SHOP</Link>
                        <Link href="#" className="text-gray-600 hover:text-teal-500">MEATS & SEAFOOD</Link>
                        <Link href="#" className="text-gray-600 hover:text-teal-500">BAKERY</Link>
                        <Link href="#" className="text-gray-600 hover:text-teal-500">BEVERAGES</Link>
                        <Link href="/blog" className="text-gray-600 hover:text-teal-500">BLOG</Link>
                        <Link href="#" className="text-gray-600 hover:text-teal-500">CONTACT</Link>
                    </div>
                </div>
            </div>
        </>
